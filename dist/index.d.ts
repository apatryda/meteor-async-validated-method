...
export declare type ValidatedMethodCallAsyncFnWrapper<Args extends ValidatedMethodArgs = undefined, Result extends ValidatedMethodResult = void> = (self: RawValidatedMethod<Args, Result>, args?: Args) => Promise<Result>;
